...
const RegisterPage = () => {
    ...
    return (
        <div className="flex items-center justify-center h-screen bg-gray-800 text-white">
            ...
            <p className="flex items-center justify-center text-white text-lg">Create Your Account</p><br/>
            <h3 className="text-[1.2rem]">Do coding Quests with CodeQuest</h3><br/>
            <form onSubmit={handleRegister}>
                ...
                <div className="flex items-center justify-center"><p>Already have an account? <a href = "@" className="text-blue-300 hover:text-blue-500 hover:underline" >SignIn</a></p></div>
